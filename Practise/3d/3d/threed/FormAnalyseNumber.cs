...
namespace threed
{
    public partial class FormAnalyseNumber : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int nowLeftOut = 0;
            List<string> allLeftOut = new List<string>();
            int maxLeftou = 0;
            int index = 0;
            int count = 0;
            ...
            foreach (string number in allNumberLIst)
            {
                count = 0;
                index++;
                allLeftOut = new List<string>(); maxLeftou = 0; nowLeftOut = 0; allNumberLIst = new List<string>();
                foreach (DataRow dr in dtThreed.Rows)
                {
                    ...
                    {
                        count++;
                        allLeftOut.Add(nowLeftOut.ToString ());
                ...
                foreach (string lo in allLeftOut)
                {
                    allLeftoutStr += lo+",";
                }
